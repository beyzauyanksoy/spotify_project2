...
//
//     final featuredPlaylistModel = featuredPlaylistModelFromJson(jsonString);

// ignore_for_file: prefer_null_aware_operators, prefer_if_null_operators

import 'dart:convert';

FeaturedPlaylistModel featuredPlaylistModelFromJson(String str) =>
    FeaturedPlaylistModel.fromJson(json.decode(str));

String featuredPlaylistModelToJson(FeaturedPlaylistModel data) =>
...
class FeaturedPlaylistModel {
  ...
  factory FeaturedPlaylistModel.fromJson(Map<String, dynamic> json) =>
      FeaturedPlaylistModel(
